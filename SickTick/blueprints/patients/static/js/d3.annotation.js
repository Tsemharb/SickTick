...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-selection'), require('d3-drag'), require('d3-shape'), require('d3-dispatch')) : typeof define === 'function' && define.amd ? define(['exports', 'd3-selection', 'd3-drag', 'd3-shape', 'd3-dispatch'], factory) : factory(global.d3 = global.d3 || {}, global.d3, global.d3, global.d3, global.d3);
    ...
    var Type = function () {
        ...
        createClass(Type, [{
            ...
            value: function dragended() {
                ...
                document.getElementById('annotation-x').value = this.annotation._x;
                document.getElementById('annotation-dx').value = this.annotation._dx;
                document.getElementById('annotation-dy').value = this.annotation._dy;
                var annotation_button = document.getElementById('annotation-button');
                var e = new Event('mouseup', { bubbles: true });
                annotation_button.dispatchEvent(e);
                ///////////////////////////////////////////////////////////////////
